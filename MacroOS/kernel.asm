...
;************************************************************************************************
[SEGMENT .data]
    strWelcomeMsg   db  "Welocme to Macro_OS version 1.0.0 ---> Enter 'help' to dispaly menu", 0x00
	strPrompt		db	"Command>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"Macro_OS", 0x00	;OS details
	strMajorVer		db	"1", 0x00
	strMinorVer		db	".0.0", 0x00
	strTest			db	"Modified by G.V.M.Kulathilaka SE/2019/018.", 0x00
	...
	strHelp1		db	"ver     - display the Macro_OS version", 0x00
	strHelp2		db	"exit    - reboot", 0x00
	strHelp3		db	"hwinfo   - Display hardware information", 0x00
	strHelp4		db	"credit     - Developer details of current version", 0x00
